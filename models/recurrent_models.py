...
class LSTMGenerator(nn.Module):
    ...
    def __init__(self, in_dim, out_dim, n_layers=4, hidden_dim=256):
        super().__init__()
        ...
        self.linear = nn.Sequential(nn.Linear(hidden_dim, out_dim), nn.Sigmoid())         # change to Sigmoid for accident data[0,1]floar()
