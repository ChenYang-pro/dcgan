...
class npz_Dataset(Dataset):
    ...
    def load_data(self,category=None, with_geocode=False):   ## ?? with_geocode
        x_train_temp =  np.load(self.root_dir + '/x_train_I80.npy', allow_pickle=True)
        y_train_temp = np.load(self.root_dir + '/y_train_I80.npy', allow_pickle=True)
        x_test_temp = np.load(self.root_dir + '/x_test_I80.npy', allow_pickle=True)
        y_test_temp = np.load(self.root_dir + '/y_test_I80.npy', allow_pickle=True)
